...
exports.SiswaModule = SiswaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([siswa_entity_1.Siswa]), users_module_1.UsersModule],
        controllers: [siswa_controller_1.SiswaController],
        providers: [siswa_service_1.SiswaService, validation_service_1.ValidationService],
    })
], SiswaModule);
